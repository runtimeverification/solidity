...
bytes IeleContract::toBinary() const {
  ...
  const llvm::ArrayRef<llvm::Optional<llvm::StringRef>> redirects = {Optional<StringRef>::create(nullptr), Optional<StringRef>::create(&output), Optional<StringRef>::create(nullptr)};  
#endif
