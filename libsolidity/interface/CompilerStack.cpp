...
evmasm::LinkerObject preOptObject = compiler->assembledObject();
std::cerr << "Stats: Contract " << _contract.name() << " pre-optimization size: ";
std::cerr << preOptObject.bytecode.size() << " bytes\n";
		compiler->performDeadCodeElimination();
evmasm::LinkerObject afterOptObject = compiler->assembledObject();
std::cerr << "Stats: Contract " << _contract.name() << " after-optimization size: ";
std::cerr << afterOptObject.bytecode.size() << " bytes\n";
		...
		compiler->desugarConstantOperands();
...
std::cerr << "Stats: Contract " << _contract.name() << " after-desugaring size: ";
std::cerr << compiledContract.object.bytecode.size() << " bytes\n";
	}
