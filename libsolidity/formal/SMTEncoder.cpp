...
void SMTEncoder::endVisit(FunctionCall const& _funCall)
{
	...
	case FunctionType::Kind::Transfer:
	{
		...
		setSymbolicUnknownValue(thisBalance, TypeProvider::uint(), m_context);
...
void SMTEncoder::visitObjectCreation(FunctionCall const& _funCall)
{
	...
	setSymbolicUnknownValue(arraySize, TypeProvider::uint(), m_context);
...
void SMTEncoder::arrayPush(FunctionCall const& _funCall)
{
	...
	m_context.addAssertion(oldLength + 1 < (smt::maxValue(*TypeProvider::uint(256)) - 1));
