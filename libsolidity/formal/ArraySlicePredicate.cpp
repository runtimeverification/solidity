...
pair<bool, ArraySlicePredicate::SliceData const&> ArraySlicePredicate::create(SortPointer _sort, EncodingContext& _context)
{
	...
	smt::SymbolicIntVariable startVar{TypeProvider::uint(), TypeProvider::uint(), "start_" + tupleName, _context};
	smt::SymbolicIntVariable endVar{TypeProvider::uint(), TypeProvider::uint(), "end_" + tupleName, _context };
	smt::SymbolicIntVariable iVar{TypeProvider::uint(), TypeProvider::uint(), "i_" + tupleName, _context};
