...
public:
	...
	void addStateVariable(VariableDeclaration const& _varDecl, bigint _storageOffset, unsigned _byteOffset);
	bool isStateVariable(VariableDeclaration const& _varDecl) const { return m_stateVariables.count(&_varDecl); }
	std::pair<bigint, unsigned> storageLocationOfStateVariable(VariableDeclaration const& _varDecl) const
	{
...
private:
	...
	std::map<VariableDeclaration const*, std::pair<bigint, unsigned>> m_stateVariables;
