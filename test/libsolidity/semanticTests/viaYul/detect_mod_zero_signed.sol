contract C {
    function f(int256 a, int256 b) public pure returns (int256 x) {
        x = a % b;
    }
...
// f(int256,int256): 1, 0 -> FAILURE, 0x04
// f(int256,int256): -1, 0 -> FAILURE, 0x04
// f(int256,int256): 0, 0 -> FAILURE, 0x04
...
// g(int8,int8): -10, -3 -> -1
// g(int8,int8): 2, 2 -> 0
// g(int8,int8): 1, 0 -> FAILURE, 0x04
// g(int8,int8): -1, 0 -> FAILURE, 0x04
// g(int8,int8): 0, 0 -> FAILURE, 0x04
// g(int8,int8): 0, 1 -> 0
// g(int8,int8): 0, -1 -> 0
