...
BOOST_AUTO_TEST_CASE(accessors_mapping_for_array)
{
	...
	ABI_CHECK(callContractFunction("data(uint, 256)", 2, 8), encodeArgs());
...
BOOST_AUTO_TEST_CASE(complex_accessors)
{
	...
	compileAndRun(sourceCode);
	ABI_CHECK(callContractFunction("to_string_map(uint)", 42), encodeArgs("24"));
...
BOOST_AUTO_TEST_CASE_EXPECTED_FAILURES(uncalled_blockhash, 1)
...
BOOST_AUTO_TEST_CASE_EXPECTED_FAILURES(packed_keccak256_complex_types, 1)
...
BOOST_AUTO_TEST_CASE(bytes_inside_mappings)
{
	...
	ABI_CHECK(callContractFunction("set(uint)", 1, 2), encodeArgs(true));
	ABI_CHECK(callContractFunction("set(uint)", 2, 2, 3, 4, 5), encodeArgs(true));
	BOOST_CHECK(!storageEmpty(m_contractAddress));
...
BOOST_AUTO_TEST_CASE(accessor_involving_strings)
{
	...
	BOOST_REQUIRE(callContractFunction("set(uint,uint,string,uint,string)", args) == encodeArgs(true));
...
BOOST_AUTO_TEST_CASE_EXPECTED_FAILURES(arrays_from_and_to_storage, 2)
...
BOOST_AUTO_TEST_CASE_EXPECTED_FAILURES(arrays_complex_from_and_to_storage, 2)
...
BOOST_AUTO_TEST_CASE(inline_array_strings_from_document)
{
	...
	compileAndRun(sourceCode);
	ABI_CHECK(callContractFunction("f(uint)", u256(0)), encodeArgs(u256(0x20), u256(4), string("This")));
	ABI_CHECK(callContractFunction("f(uint)", u256(1)), encodeArgs(u256(0x20), u256(2), string("is")));
	ABI_CHECK(callContractFunction("f(uint)", u256(2)), encodeArgs(u256(0x20), u256(2), string("an")));
	ABI_CHECK(callContractFunction("f(uint)", u256(3)), encodeArgs(u256(0x20), u256(5), string("array")));
}
...
BOOST_AUTO_TEST_CASE(fixed_bytes_index_access)
{
	...
	ABI_CHECK(callContractFunction("data(uint)", u256(1)), encodeArgs("8"));
}
...
BOOST_AUTO_TEST_CASE_EXPECTED_FAILURES(cleanup_bytes_types_shortening, 1)
...
BOOST_AUTO_TEST_CASE_EXPECTED_FAILURES(correctly_initialize_memory_array_in_constructor, 1)
...
BOOST_AUTO_TEST_CASE_EXPECTED_FAILURES(calling_uninitialized_function_through_array, 1)
...
BOOST_AUTO_TEST_CASE(function_type_library_internal)
{
	...
	compileAndRun(sourceCode, 0, "C");
	ABI_CHECK(callContractFunction("f(uint[])", 0x20, 3, u256(1), u256(7), u256(3)), encodeArgs(u256(11)));
}
...
BOOST_AUTO_TEST_CASE_EXPECTED_FAILURES(revert_with_cause, 1)
...
BOOST_AUTO_TEST_CASE_EXPECTED_FAILURES(require_with_message, 1)
...
BOOST_AUTO_TEST_CASE_EXPECTED_FAILURES(bubble_up_error_messages, 1)
...
BOOST_AUTO_TEST_CASE_EXPECTED_FAILURES(bubble_up_error_messages_through_transfer, 1)
...
BOOST_AUTO_TEST_CASE_EXPECTED_FAILURES(bubble_up_error_messages_through_create, 1)
...
BOOST_AUTO_TEST_CASE_EXPECTED_FAILURES(abi_encode_with_selectorv2, 1)
...
BOOST_AUTO_TEST_CASE_EXPECTED_FAILURES(abi_encode_with_signature, 1)
...
BOOST_AUTO_TEST_CASE_EXPECTED_FAILURES(abi_encode_with_signaturev2, 1)
...
BOOST_AUTO_TEST_CASE_EXPECTED_FAILURES(abi_encode_call, 1)
...
BOOST_AUTO_TEST_CASE_EXPECTED_FAILURES(swap_peephole_optimisation, 1)
