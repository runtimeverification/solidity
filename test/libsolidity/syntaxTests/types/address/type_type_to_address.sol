...
// ----
// TypeError 9640: (96-109): Explicit type conversion not allowed from "type(uint)" to "address".
...
// TypeError 9640: (260-275): Explicit type conversion not allowed from "type(uint[] memory)" to "address".
// TypeError 9640: (285-302): Explicit type conversion not allowed from "type(uint[] memory[] memory)" to "address".
// TypeError 9640: (312-328): Explicit type conversion not allowed from "type(uint[5] memory)" to "address".
...
// TypeError 9640: (431-452): Explicit type conversion not allowed from "tuple(type(uint),type(uint))" to "address".
// TypeError 9640: (463-482): Explicit type conversion not allowed from "type(uint)" to "address".
